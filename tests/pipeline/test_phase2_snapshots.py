...
def test_render_produces_five_png_files(two_box_glb, tmp_path):
    ...
    assert frame_set.frame_d.exists()
    assert frame_set.frame_e.exists()
...
def test_render_metadata_fields(two_box_glb, tmp_path):
    ...
    assert meta.camera_angles_deg == [0.0, 10.0, 20.0, 30.0, 40.0]
...
def test_render_images_are_valid_png(two_box_glb, tmp_path):
    ...
    for frame_path in (frame_set.frame_a, frame_set.frame_b, frame_set.frame_c, frame_set.frame_d, frame_set.frame_e):
